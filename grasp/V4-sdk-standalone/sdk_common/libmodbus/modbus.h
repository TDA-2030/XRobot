...
typedef void (*libmodbus_inspector_pfn) (int flag, uint8_t* data, int size);

MODBUS_API void modbus_set_inspector(modbus_t* ctx, libmodbus_inspector_pfn inspector);
